...
function numSequence() {
    clearActive(numElements), numCounter >= numSequence.length && (numCounter = 0), printSequence(numSequence, numCounter, numElements),
        document.getElementById("display-num").innerHTML = numSequence[numCounter], numCounter++, setTimeout(numSequence, frequency);
}
